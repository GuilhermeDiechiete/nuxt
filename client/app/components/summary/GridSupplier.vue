    ...
    >
      <div class="flex flex-col gap-4 mt-4 text-sm">
        ...
        >
          ...
          <span class="flex-1 mx-2 font-medium">
            {{ supplier.name }}
          </span>
      ...
      <UButton to="/summary/suppliers" class="justify-center" color="primary" variant="soft">Resumo Completo</UButton>
      </div>
    </UPageCard>
</template>
